    ...
    return (
        <footer >
                ...
                <div className=" lg:mx-auto w-11/12 flex md:flex-row flex-col-reverse items-center lg:container md:justify-around">
                    <div className=" mb-6 mx-5 md:mx-0 md:w-2/4 md:mb-0 space-y-5 lg:ml-16 md:space-y-7">
                        ...
                        <div className="flex space-x-5 text-[#331A15]">
                            <a href="#" className="text-[#331A15] hover:text-[#E3B577] text-3xl transition duration-300">
                        ...
                        <div className="text-[#331A15] text-lg space-y-3">
                            ...
                            <p className="text-sm md:text-xl flex items-center font-sans"><FaPhoneAlt className="mr-4"></FaPhoneAlt>+8801300656028</p>
                            <p className="text-sm md:text-xl flex items-center font-sans"><MdEmail className="mr-4"></MdEmail> Email: imteajalammonna@gmail.com</p>
            ...
            <div className="h-[6vh] flex items-center justify-center" style={{ backgroundImage: `url(${footerBg})` }}>
                <h3 className=" text-lg md:text-2xl text-white">Copyright Espresso Emporium ! All Rights Reserved . Developed by Monna.❤️</h3>
            </div>
        </footer>
    );
}
